        ...
        <div className="flex flex-col items-center mt-8">
              ...
              <div className="p-4 m-0">
                <div className="border-solid border-black border-2 p-4 rounded-xl flex flex-col gap-3">
                  ...
                  <p className="text-mxs">
                    ...
                    what you can do? Come to CodeDay! 🌙
                  </p>
                  <p className="text-mxs">
                    A CodeDay is a vibrant, inclusive gathering where students
                    of all backgrounds explore the joy of coding through
                    creativity and collaboration. Participants, regardless of
                    coding experience, come together to build games and apps in
                    a supportive environment. With workshops, projects, and a
                    focus on fun, CodeDay inspires a new generation of tech
                    enthusiasts. Our events have had on over 60,000 student
                  ...
                  <p>
                    ...
                    <span className="font-bold">CodeDay Kolkata 2024</span>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Draggable disabled={!draggable} handle=".handle">
            ...
            >
              ...
              >
                <p>CodeDay login: wackycoder</p>
                <p>Password: </p>
                <p>Last login: Fri May 04 16:16:08 on tty2</p>
                <p>wackycoder@codeday:~$ _</p>
                <p>Adding user &apos;wackycoder&apos; ...</p>
