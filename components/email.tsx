                ...
                >
                  ...
                  <div className="flex flex-col gap-y-4 text-mxs">
                    ...
                    <p>
                      ...
                      things you can do as a young person. High-school is the
                      best time in our lives to do it—but{' '}
                      <span className="font-bold">
                    ...
                    <p>
                      ...
                      event, workshops, community, we want to create an
                      environment where{' '}
                      <span className="font-bold">
                  ...
                  <p className="text-mxs">💜⚡️ The CodeDay Kolkata team.</p>
                </div>
              </div>
            </Draggable>
          )}
